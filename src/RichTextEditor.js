...
export default class RichTextEditor extends Component {
  ...
  setEditorAvailableHeightBasedOnKeyboardHeight(keyboardHeight) {
    ...
    const editorAvailableHeight = -1; // Dimensions.get('window').height - (keyboardHeight * 2) - spacing;
        ...
        <View style={styles.modal}>
          <View style={[styles.innerModal, { marginBottom: PlatformIOS ? this.state.keyboardHeight : 0 }]}>
            <View style={styles.inputTitleWrapper}>
              <Text style={styles.inputTitle}>Link 입력</Text>
            </View>
  ...
  _renderModalButtons() {
    ...
    return (
      <View style={[{ marginTop: 8, height: 36, alignSelf: 'stretch', flexDirection: 'row' }]}>
        ...
        <TouchableOpacity
          ...
          style={styles.buttonPlatformStyle}
        >
          <Text style={[styles.button, { color: insertUpdateDisabled ? "#555" : "#b300a7" }]}>
            확인
          </Text>
        </TouchableOpacity>
      </View>
